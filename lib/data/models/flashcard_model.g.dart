...
const FlashcardModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'exampleTranslation': PropertySchema(
      id: 2,
      name: r'exampleTranslation',
      type: IsarType.string,
    ),
...
int _flashcardModelEstimateSize(
  ...
  bytesCount += 3 + object.exampleSentence.length * 3;
  bytesCount += 3 + object.exampleTranslation.length * 3;
...
void _flashcardModelSerialize(
  ...
  writer.writeString(offsets[1], object.exampleSentence);
  writer.writeString(offsets[2], object.exampleTranslation);
  writer.writeLong(offsets[3], object.interval);
  writer.writeDateTime(offsets[4], object.nextReviewDate);
  writer.writeString(offsets[5], object.phonetics);
...
FlashcardModel _flashcardModelDeserialize(
  ...
  object.exampleSentence = reader.readString(offsets[1]);
  object.exampleTranslation = reader.readString(offsets[2]);
  object.id = id;
  object.interval = reader.readLong(offsets[3]);
  object.nextReviewDate = reader.readDateTime(offsets[4]);
  object.phonetics = reader.readString(offsets[5]);
...
extension FlashcardModelByIndex on IsarCollection<FlashcardModel> {
  Future<FlashcardModel?> getByWord(String word) {
    return getByIndex(r'word', [word]);
  }

  FlashcardModel? getByWordSync(String word) {
  ...
  Future<List<FlashcardModel?>> getAllByWord(List<String> wordValues) {
    final values = wordValues.map((e) => [e]).toList();
    return getAllByIndex(r'word', values);
  }

  List<FlashcardModel?> getAllByWordSync(List<String> wordValues) {
    final values = wordValues.map((e) => [e]).toList();
  ...
  Future<Id> putByWord(FlashcardModel object) {
    return putByIndex(r'word', object);
  }

  Id putByWordSync(FlashcardModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'word', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByWord(List<FlashcardModel> objects) {
    return putAllByIndex(r'word', objects);
  }

  List<Id> putAllByWordSync(List<FlashcardModel> objects,
      {bool saveLinks = true}) {
...
extension FlashcardModelQueryWhere
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterWhereClause> wordEqualTo(
      String word) {
    return QueryBuilder.apply(this, (query) {
...
extension FlashcardModelQueryFilter
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterFilterCondition>
      exampleTranslationEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'exampleTranslation',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterFilterCondition>
      exampleTranslationContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'exampleTranslation',
        value: value,
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterFilterCondition>
      exampleTranslationMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'exampleTranslation',
        wildcard: pattern,
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterFilterCondition>
      phoneticsContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'phonetics',
        value: value,
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterFilterCondition>
      phoneticsMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'phonetics',
        wildcard: pattern,
...
extension FlashcardModelQuerySortBy
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy>
      sortByExampleTranslation() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'exampleTranslation', Sort.asc);
    });
  }

  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy>
      sortByExampleTranslationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'exampleTranslation', Sort.desc);
    });
  }
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy> sortByPhonetics() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'phonetics', Sort.asc);
    });
  }
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy>
      sortByPhoneticsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'phonetics', Sort.desc);
    });
  }

  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy> sortByStreak() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy> sortByWord() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'word', Sort.asc);
    });
  }

  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy> sortByWordDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FlashcardModelQuerySortThenBy
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy> thenByPhonetics() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'phonetics', Sort.asc);
    });
  }
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy> thenByStreak() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'streak', Sort.asc);
    });
  }
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy> thenByWord() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'word', Sort.asc);
    });
  }

  QueryBuilder<FlashcardModel, FlashcardModel, QAfterSortBy> thenByWordDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'word', Sort.desc);
    });
  }
...
extension FlashcardModelQueryWhereDistinct
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QDistinct>
      distinctByExampleSentence({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QDistinct>
      distinctByExampleTranslation({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'exampleTranslation',
          caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QDistinct> distinctByPhonetics(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'phonetics', caseSensitive: caseSensitive);
    });
  }

  QueryBuilder<FlashcardModel, FlashcardModel, QDistinct> distinctByStreak() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'streak');
    });
  }

  QueryBuilder<FlashcardModel, FlashcardModel, QDistinct> distinctByTranslation(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FlashcardModel, FlashcardModel, QDistinct> distinctByWord(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension FlashcardModelQueryProperty
  ...
  QueryBuilder<FlashcardModel, String, QQueryOperations>
      exampleTranslationProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'exampleTranslation');
    });
  }
  ...
  QueryBuilder<FlashcardModel, String, QQueryOperations> phoneticsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'phonetics');
    });
  }

  QueryBuilder<FlashcardModel, int, QQueryOperations> streakProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'streak');
    });
  }

  QueryBuilder<FlashcardModel, String, QQueryOperations> translationProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'translation');
    });
  }

  QueryBuilder<FlashcardModel, String, QQueryOperations> wordProperty() {
    return QueryBuilder.apply(this, (query) {
